...
clear echo "________________________________"
echo "|    |   |   |   |      \       \ "
echo "|    |   |   |   |    ___|   _   |"
echo "|    |   |___|   |   |   |  | |  |"
echo "|    |____       |   |___|  |_|  |"
...
echo "_________________________________________________________"
sleep 1
pacstrap -K /mnt base linux linux-firmware sudo networkmanager pipewire pipewire-pulse gnome grub efibootmgr git gdm
sleep 2
clear
...
echo "_________________________________________________________"
sleep 1
pacstrap -C /mnt/etc/pacman.conf -K /mnt ttf-font-awesome python firefox
sleep 2
clear
